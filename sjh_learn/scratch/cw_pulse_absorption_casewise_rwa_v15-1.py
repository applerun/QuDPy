...
def build_lab_only_figure(record: dict[str, object], *, output_dir: Path, e_min: float, e_max: float) -> Path:
    ...
    with plt.rc_context(style):
        ...
        ax_w.set_xlim(e_min, e_max)
        ax_w.set_xticks([1.50, 1.55, 1.60])
        ...
        ax_resp.set_xlim(panel3_min, panel3_max)
        ax_resp.set_xticks([1.50, 1.55, 1.60])
...
def build_lab_vs_rwa_figure(record: dict[str, object], *, output_dir: Path, e_min: float, e_max: float) -> Path:
    ...
    with plt.rc_context(style):
        ...
        ax_input_w.set_xlim(e_min, e_max)
        ax_input_w.set_xticks([1.50, 1.55, 1.60])
        ...
        ax_abs.set_xlim(e_min, e_max)
        ax_abs.set_xticks([1.50, 1.55, 1.60])
        ...
        ax_im.set_xlim(e_min, e_max)
        ax_im.set_xticks([1.50, 1.55, 1.60])
        ...
        ax_wim.set_xlim(e_min, e_max)
        ax_wim.set_xticks([1.50, 1.55, 1.60])
        ...
        ax_pe.set_xlim(e_min, e_max)
        ax_pe.set_xticks([1.50, 1.55, 1.60])
        ...
        ax_theory.set_xlim(e_min, e_max)
        ax_theory.set_xticks([1.50, 1.55, 1.60])
...
def main():
    ...
    for variant in variants:
        ...
        lab_only_paths.append(build_lab_only_figure(record, output_dir=output_dir, e_min=1.5, e_max=1.6))
        lab_vs_rwa_paths.append(build_lab_vs_rwa_figure(record, output_dir=output_dir, e_min=1.5, e_max=1.6))
